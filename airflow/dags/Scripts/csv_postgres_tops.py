...
class Airports:
    ...
    path = '/Users/workspace/Desktop/DE/my_venv/Аэропорты/airports.csv'
    name = 'airports'
...
class Airlines:
    ...
    path = '/Users/workspace/Desktop/DE/my_venv/Аэропорты/airlines.csv'
    name = 'airlines'
...
class Flights_pak:
    ...
    path = '/Users/workspace/Desktop/DE/my_venv/Аэропорты/flights_pak.csv'
    name = 'flights'
